...
export const createComponent = (api: any) => {
    ...
    const DatePicker = (props: any) => {
        ...
        const { title, value, placeholder, background_color, border, border_radius, color, height, width, margin, padding } = { ...defaultProps, ...properties } as Required<DatePickerProps>;

        // Handle value change
        const handleDateChange = (event: React.ChangeEvent<HTMLInputElement>) => {
            const newValue = event.target.value;
            console.log("DatePicker value changed:", { id, newValue, oldValue: value });
            if (updateProperties) {
